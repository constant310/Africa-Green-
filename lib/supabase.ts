...
export function friendlyError(message?: string) {
  ...
  const map: Record<string,string> = {
    ...
    LOAN_POLICY_NOT_CONFIGURED: 'Loan applications are temporarily unavailable because the active loan policy is not configured. Contact an administrator.',
    ...
    REVIEWER_ALREADY_APPROVED: 'You have already approved this request. A different authorized reviewer must provide the next approval.',
