...
const url = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://ynlmhpwytpegleafdpwb.supabase.co';
const key = process.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY || process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'sb_publishable_B6dHJGvHPWrJfO-jsEHdog_cSaaL0VP';
