...
export default function Login(){
 ...
 async function google(){setBusy(true);setMsg('');const {error}=await supabase.auth.signInWithOAuth({provider:'google',options:{redirectTo:`${appUrl()}/auth/callback`,queryParams:{access_type:'offline',prompt:'consent'}}});if(error){setBusy(false);setMsg(friendlyError(error.message));}}
