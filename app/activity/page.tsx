...
export default function ActivityPage(){
 ...
 return <main className="onboarding">
  ...
  <div className="onboardTop"><div className="container" style={{display:'flex',justifyContent:'space-between',alignItems:'center',gap:16}}><Link href="/" className="brand"><span className="brandMark">AD</span><span>Acres of Diamond<small>Account activity</small></span></Link><div className="actions"><Link className="btn" href="/documents">Statements & receipts</Link><Link className="btn" href="/notifications">Notifications</Link><Link className="btn" href="/portal">Back to member portal</Link></div></div></div>
